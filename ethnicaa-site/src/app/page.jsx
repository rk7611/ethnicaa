...
/* ============================================================
   SEO UPDATE FOR HOMEPAGE
============================================================ */
function updateHomeSEO(productCount, categoryCount) {
  const title = `Ethnicaa Wholesale — Latest Wholesale Catalogs, Sarees, Suits & Kurtis`;
  const description = `Ethnicaa Wholesale brings you the latest wholesale catalogs in Sarees, Kurtis, Salwar Suits, Pakistani Suits, Gowns, Lehengas & more. ${productCount}+ products, ${categoryCount}+ categories. Best wholesale prices with daily new arrivals.`;
  ...
  set(
    "keywords",
    "Ethnicaa, wholesale suits, wholesale sarees, wholesale kurtis, pakistan suits wholesale, gown wholesale, ethnic wear wholesale, catalog wholesale"
  );
  ...
  setOg("og:url", "https://ethnicaa.com");
...
export default function HomePage() {
  ...
  const matched = allProducts.filter((p) => {
    ...
    return prodCat === catSlug || 
      ...
      // APPLY SEO
      updateHomeSEO(allProducts.length, result.length);
    }
